...
В комплекте IDE от Microsoft Visual Studio можно поставить компилятор C++. Этот компилятор рабочий, но я не гарантирую сборку моего кода на ней. Весь мой код пишется под GNU C++ Compiler.
